...
.cite-tip {visibility: hidden; opacity: 0; position: absolute; bottom: calc(100% + 10px); left: 50%; transform: translateX(-50%); width: 460px; max-width: 92vw; max-height: 360px; overflow-y: auto; background: #0f172a; border: 1px solid #334155; padding: 0.95rem 1.1rem; border-radius: 10px; font-family: 'Inter', system-ui, sans-serif; font-weight: 400; color: var(--text); line-height: 1.55; box-shadow: 0 12px 32px rgba(0, 0, 0, 0.55); z-index: 1000; transition: opacity 0.18s ease, visibility 0.18s ease; pointer-events: none; text-align: left;}
