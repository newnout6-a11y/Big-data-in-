...
# Скрипт переехал в scripts/, поэтому добавляем в sys.path и корень,
# и core/ (notebooks.py теперь там).
_РЕПО = Path(__file__).resolve().parent.parent
sys.path.insert(0, str(_РЕПО))
sys.path.insert(0, str(_РЕПО / "core"))
