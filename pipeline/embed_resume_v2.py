...
# Bootstrap: скрипт может запускаться напрямую (`python pipeline/embed_resume_v2.py`).
# Достраиваем sys.path, чтобы найти hybrid_search в core/.
...
# Скрипт лежит в pipeline/, chunks_v2.jsonl и qdrant_db/ — в корне репо.
