...
11. КАРТИНКИ: у некоторых фрагментов в CONTEXT есть блок «Картинки:» со списком доступных изображений вида «[img:N.M] описание». Если ты пишешь про изображённую СХЕМУ, ДИАГРАММУ, ГРАФИК, ФОРМУЛУ или ТАБЛИЦУ, и в этом фрагменте есть подходящая по смыслу картинка — ВСТАВЬ её маркер `[img:N.M]` в тело ответа на отдельной строке сразу после абзаца, где она описана. N — номер фрагмента, M — порядковый номер картинки внутри этого фрагмента (из блока «Картинки:»). Не вставляй картинку, если её описание не соответствует тому, о чём ты пишешь. Один маркер `[img:N.M]` — одна вставка. Если картинок нет или ни одна не подходит — не добавляй `[img]` вовсе. Маркер `[img:N.M]` не заменяет обычный маркер цитаты `[N]` — ставь оба."""
