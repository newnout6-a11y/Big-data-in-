...
def найти_похожие(вопрос, выбранный_кейс, количество):
    ...
    # Порог релевантности: multilingual-e5 для нерелевантных вопросов даёт
    # скоры в районе 0.65-0.78 (фрагменты «похожи только потому что химия»),
    # релевантные обычно ≥ 0.80. Порог 0.78 отсекает шум, не убивая ответы.
    МИН_СХОДСТВО = 0.78
